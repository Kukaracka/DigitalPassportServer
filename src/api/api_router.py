...
from api import auth_endpoints, user_endpoints, debug_endpoints, product_endpoints, image_endpoints
...
api_router.include_router(product_endpoints.product_image_router)
api_router.include_router(image_endpoints.image_router)
